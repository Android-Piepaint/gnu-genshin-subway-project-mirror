...
> **Note: Use Minecraft 1.21 or above to play !**<br>
> To get started, download a copy of our map in **Releases** tab.<br>
> Old archive can be found at here: [Github](https://github.com/Android-Piepaint/GNU-Genshin-Subway-Project/releases)
...
## Technologies used to build this map
  This map is built in Minecraft 1.21 using [GNU/Genshin OS](https://gnugenshin.miraheze.org/wiki/GNU/Genshin/en).<br>
...
> Those data pack are forked from FlashTeens' GitHub Repository.
## If you have questions...
Use **Issues** tab on top and submit bugs or feature requests!
## Build your custom subway lines
1. Fork this repository
2. Clone your repository by using git: `git clone https://gitlab.com/Android-Piepaint/GNU-Genshin-Subway-Project.git `
...
## Copyrights
©2015\~2025, The GNU/Genshin Project, All Rights Reserved.<br>
©2019\~2025, GNU/Genshin Metro Project, All Rights Reserved.